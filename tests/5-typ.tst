...
!name: Program 31 (Wrong return type)
!code:
typ x : integer;
...
!name: Program 32 (Illegal addition)
!code:
typ x : integer;
fun f( y : logical ) : logical = x + y
!failure:
99
!end

!name: Program 33 (Illegal comparison)
!code:
typ x : integer;
fun f( y : logical ) : logical = x == y
!failure:
...
!name: Program 36 (Illegal assign)
!code:
typ x : integer;
fun f( y : logical ) : logical = x = y
!failure:
...
!name: Program 37 (Illegal return type)
!code:
var z : logical
fun f( y : logical ) : logical = y;
fun g( x : integer ) : integer = f(z)
!failure:
99
!end

!name: Program 38 (Illegal argument)
!code:
typ x : integer;
fun f( y : logical ) : logical = y;
fun g( x : integer ) : integer = f(x)
!failure:
99
!end

!name: Program 39 (Illegal assignment)
!code:
var x : integer;
fun f( y : logical ) : integer = { x=true }
!failure:
99
!end

!name: Program 40 (Illegal operator not)
!code:
var x : integer;
fun f( y : logical ) : integer = !x
!failure:
99
!end

!name: Program 41 (Illegal turk)
!code:
var x : integer;
fun f( y : logical ) : integer = { x='turk<3' }
!failure:
99
!end
