 ...
 */
public interface pinsVisitor<T> extends ParseTreeVisitor<T> {
	/**
	...
	/**
	 * Visit a parse tree produced by {@link pinsParser#integer}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInteger(pinsParser.IntegerContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#logical}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLogical(pinsParser.LogicalContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#string}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitString(pinsParser.StringContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#int_constant}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInt_constant(pinsParser.Int_constantContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#log_constant}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLog_constant(pinsParser.Log_constantContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#str_constant}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStr_constant(pinsParser.Str_constantContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#identifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIdentifier(pinsParser.IdentifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#fun}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFun(pinsParser.FunContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#typ}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTyp(pinsParser.TypContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#var}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVar(pinsParser.VarContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#arr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArr(pinsParser.ArrContext ctx);
	/**
	 * Visit a parse tree produced by {@link pinsParser#declare}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeclare(pinsParser.DeclareContext ctx);
}